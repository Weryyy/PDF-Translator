...
print("   python src/translate_pdf.py 'Mushoku Tensei Redundant Reincarnation Vol. 3.pdf' \\")
...
print("   1. Copy the example config: cp config/config.example.json config/config.json")
print("   2. Edit config/config.json and add your API key")
print()
